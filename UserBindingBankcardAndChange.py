...
from Projects.PC.TestCases.User.Common.user_banding_bankcard import user_banding_bankcard
...
@test_scenario()
def UserBindingBankcardAndChange(*args, **kwargs):
    """
    用户注册-绑定银行卡-变更银行卡
    :param args:
        0: ProjectBase
    ...
    # 绑定银行卡
    ubb = user_banding_bankcard(*args, **kwargs)
    # 变更银行卡
    ubb2 = user_banding_bankcard(*args, **kwargs)
