...
class UpdatePasswordPage:
    ...
    def __init__(self, project):
        ...
        # 输入验证码
        self._psw_change_code_tag = "//*[@resource-id='com.jinjilie.daxuezhang.debug:id/psw_change_code_et']"
        # 输入新密码
        self._psw_change_new1_tag = "//*[@resource-id='com.jinjilie.daxuezhang.debug:id/psw_change_new1_et']"
        # 获取验证码按钮
        self._get_code_button_tag = "//*[@resource-id='com.jinjilie.daxuezhang.debug:id/psw_change_get_code_tv']"
        # 提交按钮
        self._submit_button_tag = "//*[@resource-id='com.jinjilie.daxuezhang.debug:id/psw_change_ensure_tv']"
        # endregion Fields
    ...
    def psw_change_new1(self):
        ...
        element = None
        try:
            element = self.Android.get_element(self._psw_change_new1_tag)
        except AttributeError as error:
            log(error)
        return element
