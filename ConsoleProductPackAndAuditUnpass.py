...
from Projects.PC.TestCases.Console.Admin.console_abroad_pro_audit_unpass import console_abroad_pro_audit_unpass
...
@test_scenario()
def ConsoleProductPackAndAuditUnpass(*args, **kwargs):
    """
    后台登录-商品包装-商品审核不通过
    :param args:
        0: ProjectBase
    ...
    data = Data.TEST_DATA['ConsoleProductPackAndAuditUnpass']
    ...
    # 商品审核不通过
    capap = console_abroad_pro_audit_unpass(*args, **kwargs)
