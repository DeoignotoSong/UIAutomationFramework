...
class ConsoleAbroadCenterGoodsAuditShowPage:
    def __init__(self, project):
        self.project = project
        self.url = 'http://console.dxzjjl.net.cn/abroad_center/goods_audit/show'
        # region Fields
        # 消息提示
        self._message_content_text_tag = '/html/body/div[last()]/div/div[1]/p'
        # 服务名称
        self._audit_service_name_text_tag = '/html/body/div[1]/div/section/main/div/div[3]/div[2]/div/section[1]/form/div[1]/div/span'
        # 服务已选一级类目
        self._audit_service_first_category_text_tag = '/html/body/div[1]/div/section/main/div/div[3]/div[2]/div/section[2]/div/div/div/div[3]/table/tbody/tr[1]/td[1]/div'
        # 服务已选二级类目
        self._audit_service_second_category_text_tag = '/html/body/div[1]/div/section/main/div/div[3]/div[2]/div/section[2]/div/div/div/div[3]/table/tbody/tr[1]/td[2]/div'
        # 服务已选三级类目
        self._audit_service_third_category_text_tag = '/html/body/div[1]/div/section/main/div/div[3]/div[2]/div/section[2]/div/div/div/div[3]/table/tbody/tr[1]/td[3]/div'
        # 服务已选数量
        self._audit_service_number_text_tag = '/html/body/div[1]/div/section/main/div/div[3]/div[2]/div/section[2]/div/div/div/div[3]/table/tbody/tr[1]/td[4]/div'
        # 商品名称
        self._audit_goods_name_text_tag = '/html/body/div[1]/div/section/main/div/div[4]/div/div[2]/div/section[1]/form/div[2]/div/span'
        # 商品审核ID
        self._audit_goods_id_text_tag = '/html/body/div[1]/div/section/main/div/div[4]/div/div[2]/div/section[1]/form/div[3]/div/span'
        # 审核结果
        self._audit_service_result_text_tag = '/html/body/div[1]/div/section/main/div/div[5]/div/div[3]/table/tbody/tr/td[3]/div'
        # endregion Fields
    ...
    @property
    def audit_goods_name_text(self):
        """
        属性: 商品名称
        :return: 商品名称
        """
        element = None
        try:
            element = self.project.get_element(self._audit_goods_name_text_tag)
        except AttributeError as error:
            log(error)
        return element

    @property
    def audit_goods_id_text(self):
        """
        属性: 商品审核ID
        :return: 商品审核ID
        """
        element = None
        try:
            element = self.project.get_element(self._audit_goods_id_text_tag)
        except AttributeError as error:
            log(error)
        return element
    ...
    def get_audit_goods_name_text_action(self):
        """
        动作：获取商品名称的文本
        :return: '商品名称'的文本
        """
        control_content = self.project.get_element_text(self.audit_goods_name_text)
        return control_content

    def get_audit_goods_id_text_action(self):
        """
        动作：获取商品审核ID的文本
        :return: '商品审核ID'的文本
        """
        control_content = self.project.get_element_text(self.audit_goods_id_text)
        return control_content
