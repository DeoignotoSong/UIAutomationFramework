...
@test_scenario()
def FoSchoolRegisterPass(*args, **kwargs):
    """
    海外院校注册-提交审核信息-后台登录-院校信息完善-院校审核通过-院校登录-获取院校邀请码
    :param args:
        0: ProjectBase
        1: mysql
        2: mongo
    ...
    # 初始化文件
    data = Data.TEST_DATA['FoSchoolRegisterPass']
    # 院校注册
    ...
    # 审核通过
    cinrp = console_school_rv_pass(*args, **kwargs)
    # 用户登录
