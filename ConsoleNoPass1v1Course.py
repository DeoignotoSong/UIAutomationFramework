...
@test_scenario()
def ConsoleNoPass1v1Course(*args, **kwargs):
    """
    讲师登录-发布1对1直播课-后台登录-1对1课审核不通过
    :param args:
        0: ProjectBase
        1: mysql
        2: mongo
    ...
    # test_data列表
    data = Data.TEST_DATA['ConsoleNoPass1v1Course']
    # 用户登录
    ...
    try:
        ...
        Assert.is_equal(ucvc['category'], cnpvc['review_detail_category'])
    finally:
        # 重置讲师日历表信息
