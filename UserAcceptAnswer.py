...
@test_scenario()
def UserAcceptAnswer(*args, **kwargs):
    """
    发布者登录-发布问答-用户登出-回答者登录-发布问答回答-发布者登录-采纳答案
    :param args:
        0: ProjectBase
        1: mysql
        2: mongo
    ...
    data = Data.TEST_DATA['UserAcceptAnswer']
    # 发布者登录
    ...
    # # 采纳答案
    # uaa = user_accept_answer(*args, **kwargs)
    # Assert.is_containing('采纳成功', uaa['accept_answer_success'])
