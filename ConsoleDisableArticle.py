...
from Projects.PC.TestCases.Console.Admin.console_disable_article import console_disable_article
...
@test_scenario()
def ConsoleDisableArticle(*args, **kwargs):
    """
    登录-发布文章-后台登录-文章审核通过-后台禁用文章
    :param args:
        0: ProjectBase
        1: mysql
        2: mongo
    ...
    data = Data.TEST_DATA['ConsoleDisableArticle']
    # 用户登录
    ...
    # 后台禁用文章
    cda = console_disable_article(*args, **kwargs)
