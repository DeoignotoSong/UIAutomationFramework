...
from Projects.PC.TestCases.User.Teacher.teacher_draft_small_class import teacher_draft_small_class
...
@test_scenario()
def TeacherDraftSmallClass(*args, **kwargs):
    """
    讲师登录-直播小班课保存草稿箱
    :param args:
        0: ProjectBase
    ...
    # test_data列表
    data = Data.TEST_DATA['TeacherDraftSmallClass']
    # 用户登录
    ...
    try:
        ...
        # 用户发布直播小班课
        tdsc = teacher_draft_small_class(*args, **kwargs)
    finally:
        # 重置讲师日历表信息
