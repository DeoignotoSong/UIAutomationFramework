...
from Projects.PC.TestCases.User.Teacher.teacher_check_pass_1v1 import teacher_check_pass_1v1
...
@test_scenario()
def TeacherCheckPass1v1(*args, **kwargs):
    """
    讲师登录-发布1对1直播课-后台登录-1对1课审核通过-讲师查看审核通过直播1对1
    :param args:
        0: ProjectBase
        1: mysql
        2: mongo
    ...
    # test_data列表
    data = Data.TEST_DATA['TeacherCheckPass1v1']
    # 用户登录
    ...
    try:
        ...
        # 讲师查看已审核通过的直播1对1
        tcpv = teacher_check_pass_1v1(*args, **kwargs)
