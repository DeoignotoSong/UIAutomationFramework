...
from Projects.PC.TestCases.User.Teacher.teacher_draft_public_class import teacher_draft_public_class
...
@test_scenario()
def TeacherDraftPublicClass(*args, **kwargs):
    """
    讲师登录-直播讲堂保存草稿箱
    :param args:
        0: ProjectBase
    ...
    # test_data列表
    data = Data.TEST_DATA['TeacherDraftPublicClass']
    # 用户登录
    ...
    try:
        ...
        # 用户发布直播课
        tdpc = teacher_draft_public_class(*args, **kwargs)
    finally:
        # 重置讲师日历表信息
