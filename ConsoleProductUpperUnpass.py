...
from Projects.PC.TestCases.Console.Admin.console_abroad_pro_up_ad_unpass import console_abroad_pro_up_ad_unpass
...
@test_scenario()
def ConsoleProductUpperUnpass(*args, **kwargs):
    """
    后台登录-商品包装-商品审核通过-商品上架-上架审核不通过
    :param args:
        0: ProjectBase
        1: mysql
        2: mongo
    ...
    data = Data.TEST_DATA['ConsoleProductUpperUnpass']
    ...
    # 商品上架审核不通过
    capuau = console_abroad_pro_up_ad_unpass(*args, **kwargs)
    # 商品上架状态
    ...
    Assert.is_equal('', ccgss['upper_state'])
